variable "aws_region" {
  description = "AWS region in which the forecast endpoint operates."
  type        = string
}
...
variable "forecast_endpoint_name" {
  description = "Stable SageMaker endpoint name to monitor and autoscale."
  type        = string
}

variable "forecast_endpoint_variant_name" {
  description = "Production variant name within the forecast endpoint."
  type        = string
}
