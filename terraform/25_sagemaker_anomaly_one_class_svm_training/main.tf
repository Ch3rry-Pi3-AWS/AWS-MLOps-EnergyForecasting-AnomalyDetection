...
locals {
  source_dir             = abspath("${path.module}/../../sagemaker/anomaly_one_class_svm_training")
  source_bundle_key      = var.source_bundle_key != null ? var.source_bundle_key : "sagemaker/anomaly_one_class_svm_training/source/anomaly_one_class_svm_training_source.tar.gz"
  ...
  job_base_name          = var.job_base_name != null ? var.job_base_name : "${var.deployment_name}-anomaly-ocsvm-train"
